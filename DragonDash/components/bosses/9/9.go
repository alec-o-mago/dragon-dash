components {
  id: "9"
  component: "/components/bosses/9/9.script"
}
components {
  id: "spawn"
...
embedded_components {
  id: "bullet_factory_arrow"
  type: "factory"
  data: "prototype: \"/components/boss_bullets/arrow_pink/arrow_pink_bullet.go\"\n"
  "load_dynamically: true\n"
  "dynamic_prototype: true\n"
  ""
}
